...
fun Beer.print(){print("맥주이름 : ${this.name}, 맥주타입 : ${this.beerType}, 맥주가격 : ${this.cost}\n")}
fun Beer.change_price(cost : Int){this.cost=cost}
fun Wine.euro_to_won(param: (Int, Int) -> Int?) {println("유로 : ${this.cost}, 원화 : ${param(this.cost, 1350)}\n")}
fun main(){
